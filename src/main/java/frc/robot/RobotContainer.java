...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        // Drivetrain will execute this command periodically
        // drivetrain.applyRequest(() ->
        // new SwerveRequest.ApplyRobotSpeeds().withSpeeds(d) // Drive counterclockwise
        ...
        joystick.a().onChange(Commands.runOnce(() -> {
            Drivetrain.changeState(SwerveState.Heading);
        }));
        joystick.b().onChange(Commands.runOnce(() -> {
            Drivetrain.changeState(SwerveState.TeliOp);
        }));
